  ...
  const experiences = [
    {
      ...
      description: "Building RAG systems for customer use. Implementing django backend services for multiple applications. Doing analytics work. Also got to learn frontend in the process."
    },
    {
